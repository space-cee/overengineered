...
export type { Logic as Display16BlockLogic };
...
class Logic extends InstanceBlockLogic<typeof definition> {
	...
	constructor(block: InstanceBlockLogicArgs) {
		...
		const display: Frame[][] = new Array(16);
		for (let x = 0; x < 16; x++) {
			display[x] = new Array(16);
			for (let y = 0; y < 16; y++) {
...
export const Display16Block = {
	...BlockCreation.defaults,
	id: "display16",
	displayName: "Display 16",
	description: "Simple 16x16 pixel display. Wonder what can you do with it..",
